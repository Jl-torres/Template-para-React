...
const Columna2a = () => {
    ...
    const [members, guardarMembers] =useState(
        [
        {id:'0', titulo:'John Michael', estado:'Online', imagen:'./assets/img/theme/team-1.jpg'},
        {id:'1', titulo:'Alex Smith', estado:'In a meeting', imagen:'./assets/img/theme/team-2.jpg'},
        {id:'2', titulo:'Samantha Ivy', estado:'Offline', imagen:'./assets/img/theme/team-3.jpg'},
        {id:'3', titulo:'John Michael', estado:'Online', imagen:'./assets/img/theme/team-4.jpg'}
        ]
    )   
