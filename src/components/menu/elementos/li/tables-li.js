    ...
    return (
        <>
          <li className="nav-item">
              <Link className="nav-link" to="#navbar-tables" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
              ...
              <div className="collapse" id="navbar-tables">
                <ul className="nav nav-sm flex-column">
                  ...
                  <li className="nav-item">
                    <Link to="../../pages/tables/datatables.html" className="nav-link">
